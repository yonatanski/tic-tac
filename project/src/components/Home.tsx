...
const Home = () => {
  ...
  // const [privateChat, setPrivateChat]: String = useState()
      ...
      <Row style={{ height: "95vh" }}>
        <Col md={10} className="d-flex flex-column justify-content-between">
          ...
          <Form onSubmit={handleMessageSubmit}>
            <Form.Control type="text" placeholder="Enter your message" value={message} onChange={(e) => setMessage(e.target.value)} disabled={!isLoggedIn} />
          </Form>
        </Col>
        <Col md={2}>
          {/* ONLINE USERS COL */}
